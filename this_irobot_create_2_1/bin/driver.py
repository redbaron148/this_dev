#!/usr/bin/python
import roslib; roslib.load_manifest('this_irobot_create_2_1')
import rospy
...
from this_irobot_create_2_1.msg import SensorPacket
from this_irobot_create_2_1.srv import *

class CreateDriver:
	def __init__(self):
		port = rospy.get_param('/brown/this_irobot_create_2_1/port', "/dev/ttyUSB0")
